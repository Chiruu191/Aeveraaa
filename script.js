...
const products = {    'top1': { name: 'BOXY FIT OVERSHIRT', price: '2400.00', image: 'https://static.zara.net/assets/public/666d/fe28/a07e4c6eaa07/96361fd1525a/07484553800-e3/07484553800-e3.jpg?ts=1737714778103&w=563', description: 'Boxy fit overshirt. Featuring a lapel collar, long sleeves with buttoned cuffs, hip patch pockets and a button-up front.' },
    'top2': { name: 'PAINT SPLATTER JACKET', price: '6000.00', image: 'https://static.zara.net/assets/public/3be3/e7bf/2b2841588187/c85895629b1d/08527207400-e3/08527207400-e3.jpg?ts=1738916404274&w=563', description: 'Relaxed fit jacket crafted from cotton canvas. Featuring a collared neckline, long sleeves with buttoned cuffs, front patch pockets, an all-over splatter effect and front button fastening.' },
    'top3': { name: 'TOPSTITCHED DENIM JACKET', price: '6000.00', image: 'https://static.zara.net/assets/public/bd22/141c/b39741d3b33c/d373ee6f72e4/04048491405-e3/04048491405-e3.jpg?ts=1737707200899&w=563', description: 'Relaxed fit denim jacket made of unwashed cotton denim. This gives it a stiff appearance on first wear, which will soften over time with use. Contrast shirt collar and long sleeves with elasticated cuffs. Faux shearling lining. Welt pockets at the hip and an inside pocket. Contrast topstitching throughout the garment. Zip fastening at the front.' },
    'top4': { name: 'TEXTURED JACQUARD T-SHIRT', price: '1490.00', image: 'https://static.zara.net/assets/public/1688/bf9a/9a0c4c039de2/4d44ba679c9f/04087400502-e3/04087400502-e3.jpg?ts=1737028986697&w=563', description: 'Relaxed fit T-shirt with a round neck and short sleeves.' },
    'top5': { name: 'BASIC HEAVY WEIGHT T-SHIRT', price: '1990.00', image: 'https://static.zara.net/assets/public/6442/27f8/67e64e7e889b/da6bb996d855/01887455807-e3/01887455807-e3.jpg?ts=1739197162850&w=563', description: 'Regular fit T-shirt made from compact cotton fabric. Round neck and short sleeves.' },
    'top6': { name: 'Basic Line T-Shirt', price: '1990.00', image: 'https://static.zara.net/assets/public/c5fd/816f/0baf4c8f8c34/3101d1699c61/00761412251-e3/00761412251-e3.jpg?ts=1737452357782&w=563', description: 'Regular fit T-shirt with a round neckline and short sleeves.' },
    'bottom1': { name: 'Wide Straight Jeans', price: '1990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/470542/sub/goods_470542_sub14_3x4.jpg?width=423', description: 'Pairs well with cropped tops or styled with a top tucked in.' },
    'bottom2': { name: 'Geard Pants', price: '1990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/463981/sub/goods_463981_sub14_3x4.jpg?width=423', description: 'Ideal for sports and outdoor activities to keep you feeling fresh and comfortable.' },
    'bottom3': { name: 'Sweat Wide Pants', price: '1990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/461420/sub/goods_461420_sub14_3x4.jpg?width=369', description: 'Voluminous wide straight cut with a high rise. A drawstring at the hem lets you adjust the silhouette.' },
    'bottom4': { name: 'OVERSIZED FIT DENIM BERMUDA SHORTS', price: '790.00', image: 'https://static.zara.net/assets/public/34f9/10c0/127049eb868c/ce1861c913c1/04806425406-e3/04806425406-e3.jpg?ts=1744625964753&w=563', description: 'Knee-length, five-pocket design. Metal tack buttons. Features U-shaped belt loops at the back.' },
    'bottom5': { name: 'Denim Work Shorts', price: '1290.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/477206/sub/goods_477206_sub14_3x4.jpg?width=423', description: 'Pairs well with oversized tops.' },
    'bottom6': { name: 'Geard Shorts', price: '1290.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/477165/sub/goods_477165_sub14_3x4.jpg?width=423', description: 'Perfect for everyday wear or the great outdoors.' },
    'shoe1': { name: 'Suede Combination Sneakers', price: '1490.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475346/item/goods_09_475346_3x4.jpg?width=423', description: 'Basic design goes with any style.' },
    'shoe2': { name: 'Slide Sandals', price: '1490.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475513/item/goods_57_475513_3x4.jpg?width=423', description: 'Slide sandal design is easy to slip on and off.' },
    'accessory1': { name: 'Metal Oval Sunglasses', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/477068/item/goods_05_477068_3x4.jpg?width=423', description: 'Classic oval-shaped metal frames.' },
    'accessory2': { name: 'Double Bridge Sunglasses', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/476535/item/goods_34_476535_3x4.jpg?width=423', description: 'Classic double bridge design adds a style accent to any outfit.' },
    'accessory3': { name: 'Crown Panto Sunglasses', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475139/item/goods_09_475139_3x4.jpg?width=423', description: 'Suitable for casual and more refined styles.' },
    'accessory4': { name: 'Boston Combination Sunglasses', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475133/item/goods_07_475133_3x4.jpg?width=423', description: 'The distinctive design combines plastic and metal frames.' },
    'accessory5': { name: 'Adjustable UV Protection Wide Brim Hat', price: '1490.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475178/item/goods_34_475178_3x4.jpg?width=423', description: 'Foldable design for easy carrying. Chin strap prevents your hat from blowing away.' },
    'accessory6': { name: 'UV Protection Cap Twill', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/470010/item/goods_31_470010_3x4.jpg?width=423', description: 'Adjuster and buckle plating color selected to complement the color of the fabric.' },
    'bag1': { name: 'Multi Pocket Shoulder Bag', price: '1490.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/476764/item/goods_57_476764_3x4.jpg?width=423', description: 'Designed with seven small pockets for organization and storage capacity.' },
    'bag2': { name: 'Crossbody Bag', price: '990.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/476641/item/goods_56_476641_3x4.jpg?width=423', description: 'Water-repellent finish protects against light rain. *The finish is not permanent. Designed with plenty of storage space.' },
    'bag3': { name: 'Soft Puffy Shoulder Bag', price: '1490.00', image: 'https://image.uniqlo.com/UQ/ST3/AsianCommon/imagesgoods/475638/item/goods_15_475638_3x4.jpg?width=423', description: 'Padded for a soft, puffy feel.' },
};
...
function loadProductDetails() {
    ...
    // Update the product-info div's data-product-id attribute to match the current product
    const productInfoDiv = document.querySelector('.product-info');
    if (productInfoDiv) {
        productInfoDiv.setAttribute('data-product-id', productId);
    }
    ...
    const descriptionElement = document.querySelector('.product-info .product-description p');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ... (rest of your DOMContentLoaded, e.g., loadProductDetails, loadOrders, etc.)
    if (document.body.classList.contains('product-page_body') || window.location.pathname.includes('product.html')) {
        console.log("Loading product details...");
        loadProductDetails();
    }
    if (document.querySelector('.orders-content .order-list')) {
